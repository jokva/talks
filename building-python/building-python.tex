...
\begin{frame}{CMake 2/2}
    \begin{itemize}
        \item Feature autodiscovery
        \item Compiler configuration
        \item External dependency configuration
        \item Easy debug/release builds
        \item File-object dependency tracking
